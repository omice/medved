...
class Kohana_Validation implements ArrayAccess {
	...
	public function check()
	{
		...
		foreach ($rules as $field => $set)
		{
			...
			foreach ($set as $array)
			{
				...
				{
					// This is a lambda function, there is no error name (error must be added manually)
					$error_name = FALSE;
					$passed = call_user_func_array($rule, $params);
				}
	 ...
	 *
	 *     // Get error from messages/forms/login.php
	 *     $error = $Validation->error('forms/login');
	 *
	 * @uses    Kohana::message
