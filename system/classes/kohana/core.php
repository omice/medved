...
class Kohana_Core {
	...
	/**
	 * @var  boolean  Should error and exceptions be logged
	 */
	...
	/**
	 * @var  boolean  Enable Kohana catching and displaying PHP error and exceptions. Set by [Kohana::init]
	 */
	public static $errors = TRUE;

	/**
	 * @var  array  Types of error to display at shutdown
	 */
	 ...
	 * `boolean` | error     | Should Kohana catch PHP error and uncaught Exceptions and show the `error_view`. See [Error Handling](kohana/error) for more info. <br /> <br /> Recommended setting: `TRUE` while developing, `FALSE` on production servers. | `TRUE`
	...
	public static function init(array $settings = NULL)
	{
		...
		if (isset($settings['error']))
		{
			...
			Kohana::$errors = (bool) $settings['error'];
		}
		...
		if (Kohana::$errors === TRUE)
		{
			...
			// Enable Kohana error handling, converts all PHP error to exceptions.
			set_error_handler(array('Kohana', 'error_handler'));
		}

		// Enable the Kohana shutdown handler, which catches E_FATAL error.
	...
	/**
	 * PHP error handler, converts all error into ErrorExceptions. This handler
	...
	/**
	 * Catches error that are not caught by the error handler, such as E_PARSE.
	 *
